...
export const BRANDS: Brand[] = [
  ...
  { name: "Hofer", color: "#E2001A" },
  { name: "DM", color: "#003DA5", aliases: ["dm drogerie"] },
  { name: "Rossmann", color: "#D40511" },
  ...
  { name: "Minipreço", color: "#FFD200", aliases: ["minipreco"] },
  ...
  { name: "Bricomarché", color: "#00A651", aliases: ["bricomarche"] },
  { name: "Mr Bricolage", color: "#FFD200" },
  { name: "Truffaut", color: "#00874E" },
  ...
  { name: "Devred", color: "#1B1B3A" },
  { name: "La Halle", color: "#7A1FA2" },
  { name: "Gémo", color: "#FF6600", aliases: ["gemo"] },
  { name: "Uniqlo", color: "#FF0000" },
  { name: "Primark", color: "#00AEEF" },
  { name: "Mango", color: "#1B1B1B" },
  ...
  { name: "TK Maxx", color: "#E2231B", aliases: ["tk maxx", "tjx"] },
  ...
  { name: "Currys", color: "#5C2D91" },
  { name: "Best Buy", color: "#0046BE" },
  { name: "GameStop", color: "#FF0000" },
  { name: "Micromania", color: "#FFD200" },
  ...
  { name: "Domino's Pizza", color: "#006491", aliases: ["dominos", "dominos pizza"] },
  { name: "Pizza Hut", color: "#E2001A" },
  { name: "Costa Coffee", color: "#6C1F45" },
  { name: "Five Guys", color: "#E51937" },
  ...
  { name: "LCL", color: "#00A2E0" },
  { name: "Boursorama", color: "#FF0000" },
  ...
  { name: "Animalis", color: "#00A651" },
  { name: "Pets at Home", color: "#00A651" },
  { name: "Fressnapf", color: "#FF6600" },
  { name: "Kiwoko", color: "#E2001A" },

  // ═══════════════════════════════════════════════════════════════════════
  // SPORT / FITNESS
  // ═══════════════════════════════════════════════════════════════════════
  { name: "Go Sport", color: "#00A651" },
  { name: "Foot Locker", color: "#000000" },
  { name: "Sport 2000", color: "#003DA5" },
  { name: "Courir", color: "#FFD200" },
  { name: "Intersport", color: "#0066B3" },
  { name: "Basic-Fit", color: "#FF6600" },
  { name: "Vivactif", color: "#E6007E" },
  { name: "Fitness Park", color: "#000000" },
  { name: "Neoness", color: "#E6007E" },
  ...
  { name: "Gibert Jeune", color: "#E2001A" },
  { name: "Decitre", color: "#1B1B3A" },
  ...
  { name: "Esso", color: "#ED1C24" },
  { name: "Avia", color: "#003DA5" },
  { name: "Repsol", color: "#FF6600" },
  { name: "Cepsa", color: "#E30613" },
  { name: "Galp", color: "#FF6D00" },
