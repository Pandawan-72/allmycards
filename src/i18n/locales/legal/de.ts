const LEGAL_DE = {
  ...
  terms: {
    ...
    sections: [
      ...
      { title: "2. Free and Pro", body: "Kostenlos: bis zu 5 Karten. Pro (5,99 € Einmalkauf): unbegrenzte Karten, PIN-Schutz, Kategoriefilter, Ablaufbenachrichtigungen, Sicherung & Wiederherstellung, Kartenfreigabe." },
