const LEGAL_FR = {
  lastUpdated: "Dernière mise à jour : 13 juin 2026",
  editor: "All My Cards",
  ...
  privacy: {
    intro: "Cette politique explique comment All My Cards collecte, utilise et protège vos données.",
    sections: [
      { title: "1. Éditeur", body: "L'application All My Cards est éditée par Retro-Spare. Contact : dev@retro-spare.fr." },
      { title: "2. Données collectées", body: "Gratuit : jusqu'à 5 cartes. Pro (3,99 € achat unique) : cartes illimitées, protection PIN, cartes de visite vCard, photos de cartes, alertes d'expiration, sauvegarde." },
      { title: "3. Données locales", body: "Toutes vos cartes, photos, et données sont stockées exclusivement en local sur votre appareil. Elles ne sont jamais transmises à nos serveurs ni partagées avec des tiers." },
      { title: "4. Photos de cartes", body: "Les photos recto/verso de vos cartes sont stockées localement sur votre appareil et ne quittent jamais votre téléphone, sauf si vous utilisez la fonction de partage." },
      { title: "5. Utilisation des données", body: "Nous utilisons vos données uniquement pour : créer et sécuriser votre compte, gérer votre accès Pro, répondre à vos demandes de support." },
      { title: "6. Services tiers", body: "All My Cards utilise : RevenueCat (achats Pro), Google Play (paiements), open.er-api.com (aucune donnée personnelle)." },
  ...
  terms: {
    intro: "Les présentes CGU régissent l'utilisation de l'application All My Cards.",
    sections: [
      { title: "1. Acceptation", body: "En utilisant l'Application, vous acceptez les présentes CGU." },
      { title: "2. Version gratuite et Pro", body: "Gratuit : jusqu'à 5 cartes. Pro (3,99 € achat unique) : cartes illimitées, protection PIN, filtres catégories, alertes d'expiration, sauvegarde & restauration, partage de carte." },
