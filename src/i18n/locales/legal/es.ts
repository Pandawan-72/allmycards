const LEGAL_ES = {
  ...
  terms: {
    ...
    sections: [
      ...
      { title: "2. Free and Pro", body: "Gratis: hasta 5 tarjetas. Pro (5,99 € pago único): tarjetas ilimitadas, protección PIN, filtros de categoría, alertas de caducidad, copia de seguridad y restauración, compartir tarjeta." },
