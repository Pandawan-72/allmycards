const PT = {
  ...
  home: {
    ...
    scanToCreate: "Digitalizar para criar",
    scanToCreateSub: "Código de barras ou QR",
  ...
  settings: {
    ...
    proPlan: "Plano Pro",
    proActive: "Acesso Pro ativo", proInactive: "Acesso Pro inativo", googlePlayAccount: "Conta Google Play associada",
