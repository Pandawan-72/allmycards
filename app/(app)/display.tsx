        ...
        <View style={[styles.cardShareBg, { backgroundColor: card.color || cat.color, overflow: "hidden" }]}>
          ...
          {card.barcodeValue && isVCard ? (
            ...
            <View style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 44, alignItems: "center", justifyContent: "center", gap: 8 }}>
              <BrandLogo cardName={card.name} fallbackIcon={cat.icon} fallbackColor="#ffffff" size={44} rounded={8} useLetterLogo={card.useLetterLogo} letterColor={card.color || cat.color} isVCard={!!card.barcodeValue?.startsWith("BEGIN:VCARD")} />
              {card.barcodeValue ? (
      ...
      <SafeAreaView style={{ flex: 1 }} edges={["top", "bottom"]}>
        ...
        <ScrollView contentContainerStyle={{ padding: 20, alignItems: "center", gap: 20 }}>
          <View style={[styles.cardBadge, { backgroundColor: card.color || cat.color, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }]}>
            ...
            <BrandLogo cardName={card.name} fallbackIcon={cat.icon} fallbackColor="#ffffff" size={64} rounded={10} useLetterLogo={card.useLetterLogo} letterColor={card.color || cat.color} isVCard={!!card.barcodeValue?.startsWith("BEGIN:VCARD")} />
          </View>
